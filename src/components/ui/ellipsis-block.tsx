...
export const EllipsisBlock = memo(({ errors }: { errors: string[] }) => {
    ...
    <div className="relative w-full max-w-2xl rounded-xl p-0.5">
      <div className="rounded-xl p-4">
        <div className="flex items-center justify-between rounded-t-xl border-b border-gray-700 bg-neutral-900 px-4 py-2">
          ...
          <p className="text-sm font-medium text-gray-400">Error Logs</p>
          <button
        ...
        {/* ref here to extract visible text */}
        <pre
          ref={errorRef}
          className="overflow-x-auto rounded-b-xl bg-stone-800 p-4 text-sm text-blue-100"
        >
          {errors.map((e, i) => (
